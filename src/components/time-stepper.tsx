...
const styles = StyleSheet.create({
  ...
  labelLarge: { fontSize: 14, letterSpacing: 0.5, textTransform: 'uppercase' },
  labelBigFont: { fontSize: 13 },
  time: { fontFamily: Fonts.extraBold, fontSize: 24, color: Colors.ink, marginTop: 4 },
  timeLarge: { fontSize: 52, marginTop: 8 },
  timeBigFont: { fontSize: 34, marginTop: 6 },
  ampm: { fontFamily: Fonts.bold, fontSize: 13, color: Colors.inkFaint },
  ampmLarge: { fontSize: 20 },
  ampmBigFont: { fontSize: 16 },
});
