...
const styles = StyleSheet.create({
  ...
  statusTitle: { fontFamily: Fonts.bold, fontSize: 14.5, color: Colors.ink },
  statusSub: { fontFamily: Fonts.semiBold, fontSize: 12, color: Colors.inkFaint, marginTop: 2, lineHeight: 16 },
  settingsBtn: {
  ...
  settingsBtnText: { fontFamily: Fonts.extraBold, fontSize: 12.5, color: '#2B2420' },
  sectionLabel: {
  ...
  infoTitle: { fontFamily: Fonts.bold, fontSize: 14, color: Colors.ink },
  infoSub: { fontFamily: Fonts.semiBold, fontSize: 12, color: Colors.inkFaint, marginTop: 3, lineHeight: 16 },
});
